...
} from "./chunk-LTXDAAIT.js";
import {
  Checkbox_default,
  _objectWithoutPropertiesLoose,
  useThemeProps
} from "./chunk-MXSAYPER.js";
import {
  Paper_default
} from "./chunk-C7K5WGKI.js";
import {
  require_react_dom
  ...
  "node_modules/use-sync-external-store/cjs/use-sync-external-store-shim.development.js"(exports) {
    ...
    (function() {
      ...
      function useSyncExternalStore$2(subscribe, getSnapshot) {
        didWarnOld18Alpha || void 0 === React169.startTransition || (didWarnOld18Alpha = true, console.error(
      ...
      var React169 = require_react(), objectIs = "function" === typeof Object.is ? Object.is : is2, useState27 = React169.useState, useEffect49 = React169.useEffect, useLayoutEffect9 = React169.useLayoutEffect, useDebugValue = React169.useDebugValue, didWarnOld18Alpha = false, didWarnUncachedGetSnapshot = false, shim = "undefined" === typeof window || "undefined" === typeof window.document || "undefined" === typeof window.document.createElement ? useSyncExternalStore$1 : useSyncExternalStore$2;
      exports.useSyncExternalStore = void 0 !== React169.useSyncExternalStore ? React169.useSyncExternalStore : shim;
...
var require_reactMajor = __commonJS({
  "node_modules/@mui/x-internals/reactMajor.js"(exports) {
    ...
    var React169 = _interopRequireWildcard(require_react());
    var _default = exports.default = parseInt(React169.version, 10);
  }
});
...
var useGridSelector = (apiRef, selector, equals = defaultCompare) => {
  ...
  const subscribe = React9.useCallback(
    () => {
  ...
  const unsubscribe = React9.useCallback(() => {
    return () => {
      if (refs.current.subscription) {
...
function useForkRef(...refs) {
  const cleanupRef = React16.useRef(void 0);
  const refEffect = React16.useCallback((instance) => {
...
// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/getReactNodeRef/getReactNodeRef.js
var React21 = __toESM(require_react(), 1);

// node_modules/@mui/x-data-grid/node_modules/@mui/utils/esm/getReactElementRef/getReactElementRef.js
var React22 = __toESM(require_react(), 1);

// node_modules/@mui/x-internals/esm/fastMemo/fastMemo.js
var React23 = __toESM(require_react());
function fastMemo(component) {
  return React23.memo(component, fastObjectShallowCompare);
}
...
function createUseGridApiEventHandler(registryContainer2) {
  ...
  return function useGridApiEventHandler2(apiRef, eventName, handler, options) {
    ...
    const [objectRetainedByReact] = React24.useState(new ObjectToBeRetainedByReact());
    const subscription = React24.useRef(null);
    const handlerRef = React24.useRef(null);
    handlerRef.current = handler;
    const cleanupTokenRef = React24.useRef(null);
...
var GridEditInputCell = forwardRef2((props, ref) => {
  ...
  const [valueState, setValueState] = React25.useState(value);
...
function GridFilterInputValue(props) {
  ...
  const [filterValueState, setFilterValueState] = React26.useState(sanitizeFilterItemValue(item.value));
...
function GridFilterInputMultipleValue(props) {
  ...
  const handleChange = React27.useCallback((event, value) => {
...
function GridMenu(props) {
  ...
  const savedFocusRef = React28.useRef(null);
  useEnhancedEffect_default(() => {
    var _a2, _b;
    if (open) {
...
function GridActionsCell(props) {
  ...
  const [focusedButtonIndex, setFocusedButtonIndex] = React29.useState(-1);
  const [open, setOpen] = React29.useState(false);
  const apiRef = useGridApiContext();
  const rootRef = React29.useRef(null);
  const buttonRef = React29.useRef(null);
  const ignoreCallToFocus = React29.useRef(false);
  const touchRippleRefs = React29.useRef({});
  const isRtl = useRtl();
  const menuId = useId();
  ...
  React29.useImperativeHandle(focusElementRef, () => ({
    focus() {
  ...
  return (0, import_jsx_runtime5.jsxs)("div", _extends({
    ...
    children: [iconButtons.map((button, index) => React29.cloneElement(button, {
      key: index,
      ...
      children: (0, import_jsx_runtime5.jsx)(MenuList_default, {
        ...
        variant: "menu",
        autoFocusItem: true,
        children: menuButtons.map((button, index) => React29.cloneElement(button, {
          key: index,
          closeMenu: hideMenu
        }))
      })
...
function GridBooleanCellRaw(props) {
  ...
  const Icon = React30.useMemo(() => value ? rootProps.slots.booleanCellTrueIcon : rootProps.slots.booleanCellFalseIcon, [rootProps.slots.booleanCellFalseIcon, rootProps.slots.booleanCellTrueIcon, value]);
...
var GridBooleanCell = React30.memo(GridBooleanCellRaw);
...
function GridEditBooleanCell(props) {
  ...
  const id = useId();
  const [valueState, setValueState] = React31.useState(value);
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  };
  const classes2 = useUtilityClasses4(ownerState);
  const handleChange = React31.useCallback(async (event) => {
...
function GridFilterInputBoolean(props) {
  ...
  const [filterValueState, setFilterValueState] = React32.useState(sanitizeFilterItemValue2(item.value));
  const rootProps = useGridRootProps();
  const labelId = useId();
  ...
  const onFilterChange = React32.useCallback((event) => {
...
var GridCellCheckboxForwardRef = forwardRef2(function GridCellCheckboxRenderer(props, ref) {
  ...
  const checkboxElement = React33.useRef(null);
  ...
  const handleKeyDown = React33.useCallback((event) => {
    if (event.key === " ") {
      event.stopPropagation();
    }
  }, []);
...
function useGridLogger(privateApiRef, name) {
  const logger = React35.useRef(null);
  if (logger.current) {
...
var useRunOnce = (condition, effect) => {
  const didRun = React37.useRef(false);
  useEnhancedEffect_default(() => {
...
function GridFilterInputDate(props) {
  ...
  const filterTimeout = useTimeout();
  const [filterValueState, setFilterValueState] = React40.useState(() => convertFilterItemValueToInputValue(item.value, type));
  const [applying, setIsApplying] = React40.useState(false);
  const id = useId();
  const rootProps = useGridRootProps();
  const onFilterChange = React40.useCallback((event) => {
    filterTimeout.clear();
...
function GridEditDateCell(props) {
  ...
  const valueTransformed = React41.useMemo(() => {
    let parsedDate;
    if (valueProp == null) {
      parsedDate = null;
  ...
  const [valueState, setValueState] = React41.useState(valueTransformed);
  const rootProps = useGridRootProps();
  const ownerState = {
    classes: rootProps.classes
  };
  const classes2 = useUtilityClasses7(ownerState);
  const parseValueToDate = React41.useCallback((value) => {
    if (value === "") {
      return null;
    }
  ...
  const handleChange = React41.useCallback(async (event) => {
...
function GridEditSingleSelectCell(props) {
  ...
  const [open, setOpen] = React42.useState(initialOpen);
  const baseSelectProps = ((_a = rootProps.slotProps) == null ? void 0 : _a.baseSelect) || {};
  const isSelectNative = baseSelectProps.native ?? false;
...
function GridFilterInputSingleSelect(props) {
  ...
  const currentValueOptions = React43.useMemo(() => {
...
function GridFilterInputMultipleSingleSelect(props) {
  ...
  const getOptionValue = resolvedColumn == null ? void 0 : resolvedColumn.getOptionValue;
  const getOptionLabel = resolvedColumn == null ? void 0 : resolvedColumn.getOptionLabel;
  const isOptionEqualToValue = React44.useCallback((option, value) => getOptionValue(option) === getOptionValue(value), [getOptionValue]);
  const resolvedValueOptions = React44.useMemo(() => {
    return getValueOptions(resolvedColumn) || [];
  }, [resolvedColumn]);
  const filteredValues = React44.useMemo(() => {
  ...
  const handleChange = React44.useCallback((event, value) => {
    applyValue(_extends({}, item, {
...
function GridScrollAreaContent(props) {
  ...
  const [canScrollMore, setCanScrollMore] = React45.useState(getCanScrollMore);
  const rootProps = useGridRootProps();
...
var GridPrivateApiContext = React46.createContext(void 0);
if (true) {
  GridPrivateApiContext.displayName = "GridPrivateApiContext";
}
function useGridPrivateApiContext() {
  const privateApiRef = React46.useContext(GridPrivateApiContext);
...
var useGridVirtualScroller = () => {
  ...
  const isRenderContextReady = React48.useRef(false);
  ...
  const previousSize = React48.useRef(null);
  const mainRefCallback = React48.useCallback((node) => {
  ...
  const scrollPosition = React48.useRef(((_a = rootProps.initialState) == null ? void 0 : _a.scroll) ?? EMPTY_SCROLL_POSITION);
  const ignoreNextScrollEvent = React48.useRef(false);
  ...
  const onContentSizeApplied = React48.useCallback((node) => {
    if (!node) {
      return;
    }
...
var GridConfigurationContext = React51.createContext(void 0);
if (true) {
...
var useGridConfiguration = () => {
  const configuration2 = React52.useContext(GridConfigurationContext);
...
var GridVirtualScrollbar = forwardRef2(function GridVirtualScrollbar2(props, ref) {
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const isLocked = React59.useRef(false);
  const lastPosition = React59.useRef(0);
  const scrollbarRef = React59.useRef(null);
...
function useProps(allProps) {
  return React62.useMemo(() => groupForwardedProps(allProps), [allProps]);
}
...
var GridCell = forwardRef2(function GridCell2(props, ref) {
  ...
  const cellRef = React63.useRef(null);
  const handleRef = useForkRef(ref, cellRef);
  const focusElementRef = React63.useRef(null);
  ...
  const publishMouseUp = React63.useCallback((eventName) => (event) => {
  ...
  const publishMouseDown = React63.useCallback((eventName) => (event) => {
    const params = apiRef.current.getCellParams(rowId, field || "");
    apiRef.current.publishEvent(eventName, params, event);
    if (onMouseDown) {
      onMouseDown(event);
  ...
  const publish = React63.useCallback((eventName, propHandler) => (event) => {
  ...
  if (React63.isValidElement(children) && canManageOwnFocus) {
...
true ? GridCell.propTypes = {
  ...
  pinnedOffset: import_prop_types20.default.number,
  pinnedPosition: import_prop_types20.default.oneOf([0, 1, 2, 3]).isRequired,
  row: import_prop_types20.default.object.isRequired,
  ...
  showLeftBorder: import_prop_types20.default.bool.isRequired,
  showRightBorder: import_prop_types20.default.bool.isRequired,
...
var GridActionsCellItem = forwardRef2((props, ref) => {
  ...
  if (!props.showInMenu) {
    ...
    return (0, import_jsx_runtime31.jsx)(rootProps.slots.baseIconButton, _extends({
      ...
      ref,
      children: React64.cloneElement(icon2, {
        fontSize: "small"
      })
    }));
  }
...
function GridSkeletonCell(props) {
  ...
  const skeletonProps = React65.useMemo(() => {
...
function GridHeader() {
  var _a;
  const rootProps = useGridRootProps();
  return (0, import_jsx_runtime34.jsxs)(React67.Fragment, {
...
var GridRoot = forwardRef2(function GridRoot2(props, ref) {
  ...
  const rootMountCallback = React68.useCallback((node) => {
    if (node === null) {
      return;
    }
...
var ColumnHeaderMenuIcon = React72.memo((props) => {
  var _a, _b;
  const {
    colDef,
    open,
  ...
  const handleMenuIconClick = React72.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
...
function GridColumnHeaderTitle(props) {
  ...
  const rootProps = useGridRootProps();
  const titleRef = React74.useRef(null);
  const [tooltip, setTooltip] = React74.useState("");
  const handleMouseOver = React74.useCallback(() => {
...
function GridColumnHeaderSeparatorRaw(props) {
  ...
  const stopClick = React75.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
  }, []);
  return (
...
var GridColumnHeaderSeparator = React75.memo(GridColumnHeaderSeparatorRaw);
...
var GridGenericColumnHeaderItem = forwardRef2(function GridGenericColumnHeaderItem2(props, ref) {
  ...
  const apiRef = useGridPrivateApiContext();
  const rootProps = useGridRootProps();
  const headerCellRef = React76.useRef(null);
...
function GridColumnHeaderItem(props) {
  ...
  const iconButtonRef = React77.useRef(null);
  const [showColumnMenuIcon, setShowColumnMenuIcon] = React77.useState(columnMenuOpen);
  const isDraggable = React77.useMemo(() => !rootProps.disableColumnReorder && !disableReorder && !colDef.disableReorder, [rootProps.disableColumnReorder, disableReorder, colDef.disableReorder]);
  let headerComponent;
  ...
  const publish = React77.useCallback((eventName) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    apiRef.current.publishEvent(eventName, apiRef.current.getColumnHeaderParams(colDef.field), event);
  }, [apiRef, colDef.field]);
  const mouseEventsHandlers = React77.useMemo(() => ({
  ...
  const draggableEventHandlers = React77.useMemo(() => isDraggable ? {
    onDragStart: publish("columnHeaderDragStart"),
    onDragEnter: publish("columnHeaderDragEnter"),
    onDragOver: publish("columnHeaderDragOver"),
    onDragEnd: publish("columnHeaderDragEnd")
  } : {}, [isDraggable, publish]);
  const columnHeaderSeparatorProps = React77.useMemo(() => ({
  ...
  const handleExited = React77.useCallback(() => {
  ...
  const columnTitleIconButtons = (0, import_jsx_runtime44.jsxs)(React77.Fragment, {
  ...
  const style = React77.useMemo(() => attachPinnedStyle(_extends({}, props.style), isRtl, pinnedPosition, pinnedOffset), [pinnedPosition, pinnedOffset, props.style, isRtl]);
...
true ? GridColumnHeaderItem.propTypes = {
  ...
  pinnedOffset: import_prop_types30.default.number,
  pinnedPosition: import_prop_types30.default.oneOf([0, 1, 2, 3]),
  separatorSide: import_prop_types30.default.oneOf(["left", "right"]),
  showLeftBorder: import_prop_types30.default.bool.isRequired,
  showRightBorder: import_prop_types30.default.bool.isRequired,
...
var GridColumnHeaderSortIcon = React79.memo(GridColumnHeaderSortIconRaw);
...
function GridColumnHeaderFilterIconButton(props) {
  ...
  const panelId = useId();
  const toggleFilter = React80.useCallback((event) => {
    event.preventDefault();
    event.stopPropagation();
    const {
      open,
...
var GridColumnMenuContainer = forwardRef2(function GridColumnMenuContainer2(props, ref) {
  ...
  const handleListKeyDown = React82.useCallback((event) => {
    if (event.key === "Tab") {
      event.preventDefault();
    }
...
var useGridColumnMenuSlots = (props) => {
  ...
  const processedComponents = React83.useMemo(() => _extends({}, defaultSlots2, slots), [defaultSlots2, slots]);
  const processedSlotProps = React83.useMemo(() => {
  ...
  const userItems = React83.useMemo(() => {
...
function GridColumnMenuHideItem(props) {
  ...
  const toggleColumn = React84.useCallback((event) => {
    if (disabled) {
      return;
    }
...
function GridColumnMenuManageItem(props) {
  ...
  const apiRef = useGridApiContext();
  const rootProps = useGridRootProps();
  const showColumns = React85.useCallback((event) => {
    onClick(event);
...
function GridColumnMenuColumnsItem(props) {
  return (0, import_jsx_runtime52.jsxs)(React86.Fragment, {
...
function GridColumnMenuSortItem(props) {
  ...
  const rootProps = useGridRootProps();
  const sortDirection = React88.useMemo(() => {
    if (!colDef) {
      return null;
    }
  ...
  const sortingOrder = colDef.sortingOrder ?? rootProps.sortingOrder;
  const onSortMenuItemClick = React88.useCallback((event) => {
    onClick(event);
...
true ? GridGenericColumnMenu.propTypes = {
   ...
   * @ignore - do not document.
   */
  defaultSlotProps: import_prop_types39.default.object.isRequired,
  /**
   * Initial `slots` - it is internal, to be overrriden by Pro or Premium packages
   * @ignore - do not document.
   */
  defaultSlots: import_prop_types39.default.object.isRequired,
...
var GridPanel = forwardRef2((props, ref) => {
  ...
  const [isPlaced, setIsPlaced] = React92.useState(false);
  const handleClickAway = React92.useCallback(() => {
    apiRef.current.hidePreferences();
  }, [apiRef]);
  const handleKeyDown = React92.useCallback((event) => {
    if (event.key === "Escape") {
      apiRef.current.hidePreferences();
    }
  }, [apiRef]);
  const modifiers = React92.useMemo(() => [{
    name: "flip",
    enabled: true,
    options: {
  ...
  const [anchorEl, setAnchorEl] = React92.useState(null);
  React92.useEffect(() => {
    var _a, _b;
...
true ? GridPanel.propTypes = {
  ...
  ownerState: import_prop_types42.default.object
} : void 0;
...
var GridFilterForm = forwardRef2(function GridFilterForm2(props, ref) {
  ...
  const valueRef = React96.useRef(null);
  const filterSelectorRef = React96.useRef(null);
  ...
  const sortedFilteredColumns = React96.useMemo(() => {
    switch (columnsSort) {
      case "asc":
  ...
  const currentOperator = React96.useMemo(() => {
    var _a2;
  ...
  const changeColumn = React96.useCallback((event) => {
  ...
  const changeOperator = React96.useCallback((event) => {
  ...
  const changeLogicOperator = React96.useCallback((event) => {
  ...
  React96.useImperativeHandle(focusElementRef, () => ({
    focus: () => {
      var _a2;
...
true ? GridFilterForm.propTypes = {
   ...
   */
  applyFilterChanges: import_prop_types46.default.func.isRequired,
  /**
   * Callback called when the logic operator is changed.
   * @param {GridLogicOperator} operator The new logic operator.
   */
  applyMultiFilterOperatorChanges: import_prop_types46.default.func.isRequired,
  /**
   * @ignore - do not document.
   */
   ...
   */
  deleteFilter: import_prop_types46.default.func.isRequired,
  /**
   ...
   */
  disableMultiFilterOperator: import_prop_types46.default.bool,
  /**
   ...
   */
  hasMultipleFilters: import_prop_types46.default.bool.isRequired,
  /**
   ...
   */
  showMultiFilterOperators: import_prop_types46.default.bool,
  /**
...
var GridFilterPanel = forwardRef2(function GridFilterPanel2(props, ref) {
  ...
  const lastFilterRef = React97.useRef(null);
  const placeholderFilter = React97.useRef(null);
  const {
    logicOperators = [GridLogicOperator.And, GridLogicOperator.Or],
    columnsSort,
    filterFormProps,
  ...
  const applyFilterLogicOperator = React97.useCallback((operator) => {
    apiRef.current.setFilterLogicOperator(operator);
  }, [apiRef]);
  const getDefaultFilter = React97.useCallback(() => {
  ...
  const getNewFilter = React97.useCallback(() => {
  ...
  const {
    readOnlyFilters,
    validFilters
  } = React97.useMemo(() => items.reduce((acc, item) => {
  ...
  const addNewFilter = React97.useCallback(() => {
  ...
  const deleteFilter = React97.useCallback((item) => {
  ...
  const handleRemoveAll = React97.useCallback(() => {
...
true ? GridFilterPanel.propTypes = {
   ...
   * @default false
   */
  disableAddFilterButton: import_prop_types47.default.bool,
  /**
   * If `true`, the `Remove all` button will be disabled
   * @default false
   */
  disableRemoveAllButton: import_prop_types47.default.bool,
  /**
   * Props passed to each filter form.
   */
  filterFormProps: import_prop_types47.default.shape({
   ...
   */
  getColumnForNewFilter: import_prop_types47.default.func,
  /**
   * Sets the available logic operators.
   * @default [GridLogicOperator.And, GridLogicOperator.Or]
   */
...
function GridColumnsManagement(props) {
  ...
  const handleSearchReset = React98.useCallback(() => {
    setSearchValue("");
    searchInputRef.current.focus();
  }, []);
  return (0, import_jsx_runtime64.jsxs)(React98.Fragment, {
...
true ? GridColumnsManagement.propTypes = {
   ...
   * @default true
   */
  autoFocusSearchField: import_prop_types48.default.bool,
  /**
   * If `true`, the `Reset` button will not be disabled
   * @default false
   */
  disableResetButton: import_prop_types48.default.bool,
  /**
   * If `true`, the `Show/Hide all` toggle checkbox will not be displayed.
   * @default false
   */
  disableShowHideToggle: import_prop_types48.default.bool,
  /**
   ...
   */
  getTogglableColumns: import_prop_types48.default.func,
  searchInputProps: import_prop_types48.default.object,
  searchPredicate: import_prop_types48.default.func,
  sort: import_prop_types48.default.oneOf(["asc", "desc"]),
  /**
   ...
   * @default 'all'
   */
  toggleAllMode: import_prop_types48.default.oneOf(["all", "filteredOnly"])
} : void 0;
...
var GridToolbarDensitySelector = forwardRef2(function GridToolbarDensitySelector2(props, ref) {
  ...
  const buttonRef = React100.useRef(null);
  ...
  const startIcon = React100.useMemo(() => {
    switch (density) {
      case "compact":
  ...
  return (0, import_jsx_runtime66.jsxs)(React100.Fragment, {
...
var GridToolbarFilterButton = forwardRef2(function GridToolbarFilterButton2(props, ref) {
  ...
  const tooltipContentNode = React101.useMemo(() => {
    if (preferencePanel.open) {
...
var GridToolbarExportContainer = forwardRef2(function GridToolbarExportContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime68.jsxs)(React102.Fragment, {
...
true ? GridCsvExportMenuItem.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  hideMenu: import_prop_types53.default.func,
  options: import_prop_types53.default.shape({
    allColumns: import_prop_types53.default.bool,
    delimiter: import_prop_types53.default.string,
    disableToolbarButton: import_prop_types53.default.bool,
    escapeFormulas: import_prop_types53.default.bool,
    fields: import_prop_types53.default.arrayOf(import_prop_types53.default.string),
    fileName: import_prop_types53.default.string,
    getRowsToExport: import_prop_types53.default.func,
    includeColumnGroupsHeaders: import_prop_types53.default.bool,
    includeHeaders: import_prop_types53.default.bool,
    shouldAppendQuotes: import_prop_types53.default.bool,
    utf8WithBom: import_prop_types53.default.bool
  })
} : void 0;
...
true ? GridPrintExportMenuItem.propTypes = {
  ...
  options: import_prop_types53.default.shape({
    allColumns: import_prop_types53.default.bool,
    bodyClassName: import_prop_types53.default.string,
    copyStyles: import_prop_types53.default.bool,
    disableToolbarButton: import_prop_types53.default.bool,
    fields: import_prop_types53.default.arrayOf(import_prop_types53.default.string),
    fileName: import_prop_types53.default.string,
    getRowsToExport: import_prop_types53.default.func,
    hideFooter: import_prop_types53.default.bool,
    hideToolbar: import_prop_types53.default.bool,
    includeCheckboxes: import_prop_types53.default.bool,
    pageStyle: import_prop_types53.default.oneOfType([import_prop_types53.default.func, import_prop_types53.default.string])
  })
} : void 0;
var GridToolbarExport = forwardRef2(function GridToolbarExport2(props, ref) {
  ...
  return (0, import_jsx_runtime69.jsx)(GridToolbarExportContainer, _extends({}, other, {
    ref,
    children: preProcessedButtons.map((button, index) => React103.cloneElement(button.component, {
      key: index
    }))
  }));
});
...
function GridToolbarQuickFilter(props) {
  ...
  const [searchValue, setSearchValue] = React104.useState(() => quickFilterFormatter(quickFilterValues ?? []));
  const prevQuickFilterValuesRef = React104.useRef(quickFilterValues);
  React104.useEffect(() => {
  ...
  const updateSearchValue = React104.useCallback((newSearchValue) => {
    const newQuickFilterValues = quickFilterParser(newSearchValue);
    prevQuickFilterValuesRef.current = newQuickFilterValues;
    apiRef.current.setQuickFilterValues(newQuickFilterValues);
  }, [apiRef, quickFilterParser]);
  const debouncedUpdateSearchValue = React104.useMemo(() => debounce(updateSearchValue, debounceMs), [updateSearchValue, debounceMs]);
  React104.useEffect(() => debouncedUpdateSearchValue.clear, [debouncedUpdateSearchValue]);
  const handleSearchValueChange = React104.useCallback((event) => {
    const newSearchValue = event.target.value;
    setSearchValue(newSearchValue);
    debouncedUpdateSearchValue(newSearchValue);
  }, [debouncedUpdateSearchValue]);
  const handleSearchReset = React104.useCallback(() => {
    setSearchValue("");
    updateSearchValue("");
  }, [updateSearchValue]);
...
true ? GridToolbar.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "pnpm proptypes"  |
  // ----------------------------------------------------------------------
  csvOptions: import_prop_types55.default.object,
  printOptions: import_prop_types55.default.object,
  /**
...
var GridSkeletonLoadingOverlay = forwardRef2(function GridSkeletonLoadingOverlay2(props, forwardedRef) {
  ...
  const inViewportCount = React109.useMemo(() => positions.filter((value) => value <= totalWidth).length, [totalWidth, positions]);
  const allVisibleColumns = useGridSelector(apiRef, gridVisibleColumnDefinitionsSelector);
  const columns = React109.useMemo(() => allVisibleColumns.slice(0, inViewportCount), [allVisibleColumns, inViewportCount]);
  const pinnedColumns = useGridSelector(apiRef, gridVisiblePinnedColumnDefinitionsSelector);
  const getPinnedPosition = React109.useCallback((field) => {
  ...
  const children = React109.useMemo(() => {
    const array = [];
...
var GridPagination = forwardRef2(function GridPagination2(props, ref) {
  ...
  const computedProps = React112.useMemo(() => {
  ...
  const lastPage = React112.useMemo(() => Math.max(0, pageCount - 1), [pageCount]);
  const computedPage = React112.useMemo(() => {
    if (rowCount === -1) {
      return paginationModel.page;
    }
    return paginationModel.page <= lastPage ? paginationModel.page : lastPage;
  }, [lastPage, paginationModel.page, rowCount]);
  const handlePageSizeChange = React112.useCallback((event) => {
    const pageSize = Number(event.target.value);
    apiRef.current.setPageSize(pageSize);
  }, [apiRef]);
  const handlePageChange = React112.useCallback((_, page) => {
  ...
  if (true) {
    const warnedOnceMissingInPageSizeOptions = React112.useRef(false);
...
var GridRow = forwardRef2(function GridRow2(props, refProp) {
  ...
  const publish = React114.useCallback((eventName, propHandler) => (event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
    if (!apiRef.current.getRow(rowId)) {
  ...
  const publishClick = React114.useCallback((event) => {
...
true ? GridRow.propTypes = {
  ...
  gridHasFiller: import_prop_types62.default.bool.isRequired,
  /**
  ...
  scrollbarWidth: import_prop_types62.default.number.isRequired,
...
var useGridRowAriaAttributes = () => {
  ...
  const headerGroupingMaxDepth = useGridSelector(apiRef, gridColumnGroupsHeaderMaxDepthSelector);
  return React115.useCallback((rowNode, index) => {
...
function GridContextProvider({
  ...
  const apiRef = React116.useRef(privateApiRef.current.getPublicApi());
...
var useGridRefs = (apiRef) => {
  const rootElementRef = React117.useRef(null);
  const mainElementRef = React117.useRef(null);
  const virtualScrollerRef = React117.useRef(null);
  const virtualScrollbarVerticalRef = React117.useRef(null);
  const virtualScrollbarHorizontalRef = React117.useRef(null);
  const columnHeadersContainerRef = React117.useRef(null);
...
var useGridIsRtl = (apiRef) => {
  ...
  const isFirstEffect = React118.useRef(true);
  React118.useEffect(() => {
...
var useGridLoggerFactory = (apiRef, props) => {
  const getLogger = React119.useCallback((name) => {
    if (forceDebug) {
...
function useGridApiInitialization(inputApiRef, props) {
  var _a;
  const publicApiRef = React120.useRef(null);
  const privateApiRef = React120.useRef(null);
  ...
  const publishEvent = React120.useCallback((...args) => {
  ...
  const subscribeEvent = React120.useCallback((event, handler, options) => {
  ...
  React120.useImperativeHandle(inputApiRef, () => publicApiRef.current, [publicApiRef]);
  React120.useEffect(() => {
    const api = privateApiRef.current;
    return () => {
...
var useGridLocaleText = (apiRef, props) => {
  const getLocaleText = React121.useCallback((key) => {
...
var useGridPipeProcessing = (apiRef) => {
  const cache2 = React122.useRef({});
  const isRunning = React122.useRef(false);
  const runAppliers = React122.useCallback((groupCache) => {
  ...
  const registerPipeProcessor = React122.useCallback((group, id, processor) => {
  ...
  const registerPipeApplier = React122.useCallback((group, id, applier) => {
    if (!cache2.current[group]) {
      cache2.current[group] = {
        processors: /* @__PURE__ */ new Map(),
        processorsAsArray: [],
  ...
  const requestPipeProcessorsApplication = React122.useCallback((group) => {
    runAppliers(cache2.current[group]);
  }, [runAppliers]);
  const applyPipeProcessors = React122.useCallback((...args) => {
...
var useGridRegisterPipeProcessor = (apiRef, group, callback, enabled = true) => {
  const cleanup = React123.useRef(null);
  const id = React123.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
...
var useGridRegisterPipeApplier = (apiRef, group, callback) => {
  const cleanup = React124.useRef(null);
  const id = React124.useRef(`mui-${Math.round(Math.random() * 1e9)}`);
  const registerPreProcessor = React124.useCallback(() => {
    cleanup.current = apiRef.current.registerPipeApplier(group, id.current, callback);
  }, [apiRef, callback, group]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React124.useRef(true);
  React124.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridRegisterStrategyProcessor = (apiRef, strategyName, group, processor) => {
  const registerPreProcessor = React125.useCallback(() => {
    apiRef.current.registerStrategyProcessor(strategyName, group, processor);
  }, [apiRef, processor, group, strategyName]);
  useFirstRender(() => {
    registerPreProcessor();
  });
  const isFirstRender = React125.useRef(true);
  React125.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
    } else {
...
var useGridStrategyProcessing = (apiRef) => {
  const availableStrategies = React126.useRef(/* @__PURE__ */ new Map());
  const strategiesCache = React126.useRef({});
  const registerStrategyProcessor = React126.useCallback((strategyName, processorName, processor) => {
    const cleanup = () => {
  ...
  const applyStrategyProcessor = React126.useCallback((processorName, params) => {
  ...
  const getActiveStrategy = React126.useCallback((strategyGroup) => {
  ...
  const setStrategyAvailability = React126.useCallback((strategyGroup, strategyName, isAvailable) => {
...
var useGridStateInitialization = (apiRef) => {
  const controlStateMapRef = React127.useRef({});
  const registerControlState = React127.useCallback((controlStateItem) => {
    controlStateMapRef.current[controlStateItem.stateId] = controlStateItem;
  }, []);
  const setState = React127.useCallback((state, reason) => {
    let newState;
    if (isFunction(state)) {
  ...
  const updateControlState = React127.useCallback((key, state, reason) => {
  ...
  const forceUpdate = React127.useCallback(() => {
  }, []);
...
var useGridInitializeState = (initializer, privateApiRef, props) => {
  const isInitialized = React129.useRef(false);
...
var useGridClipboard = (apiRef, props) => {
  ...
  const handleCopy = React130.useCallback((event) => {
...
var useGridColumnMenu = (apiRef) => {
  ...
  const showColumnMenu = React131.useCallback((field) => {
  ...
  const hideColumnMenu = React131.useCallback(() => {
    const columnMenuState = gridColumnMenuSelector(apiRef.current.state);
  ...
  const toggleColumnMenu = React131.useCallback((field) => {
...
function useGridColumns(apiRef, props) {
  ...
  const previousColumnsProp = React132.useRef(props.columns);
  ...
  const setGridColumnsState = React132.useCallback((columnsState) => {
    logger.debug("Updating columns state.");
    apiRef.current.setState(mergeColumnsState(columnsState));
    apiRef.current.publishEvent("columnsChange", columnsState.orderedFields);
  }, [logger, apiRef]);
  const getColumn = React132.useCallback((field) => gridColumnLookupSelector(apiRef)[field], [apiRef]);
  const getAllColumns = React132.useCallback(() => gridColumnDefinitionsSelector(apiRef), [apiRef]);
  const getVisibleColumns = React132.useCallback(() => gridVisibleColumnDefinitionsSelector(apiRef), [apiRef]);
  const getColumnIndex = React132.useCallback((field, useVisibleColumns = true) => {
    const columns = useVisibleColumns ? gridVisibleColumnDefinitionsSelector(apiRef) : gridColumnDefinitionsSelector(apiRef);
    return columns.findIndex((col) => col.field === field);
  }, [apiRef]);
  const getColumnPosition = React132.useCallback((field) => {
    const index = getColumnIndex(field);
    return gridColumnPositionsSelector(apiRef)[index];
  }, [apiRef, getColumnIndex]);
  const setColumnVisibilityModel = React132.useCallback((model) => {
    var _a2, _b2;
    const currentModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const updateColumns = React132.useCallback((columns) => {
    const columnsState = createColumnsState({
      apiRef,
  ...
  const setColumnVisibility = React132.useCallback((field, isVisible) => {
    const columnVisibilityModel = gridColumnVisibilityModelSelector(apiRef);
  ...
  const getColumnIndexRelativeToVisibleColumns = React132.useCallback((field) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
    return allColumns.findIndex((col) => col === field);
  }, [apiRef]);
  const setColumnIndex = React132.useCallback((field, targetIndexPosition) => {
    const allColumns = gridColumnFieldsSelector(apiRef);
  ...
  const setColumnWidth = React132.useCallback((field, width) => {
  ...
  const preferencePanelPreProcessing = React132.useCallback((initialValue, value) => {
    var _a2;
  ...
  const addColumnMenuItems = React132.useCallback((columnMenuItems) => {
  ...
  const prevInnerWidth = React132.useRef(null);
  ...
  const hydrateColumns = React132.useCallback(() => {
...
var useGridCsvExport = (apiRef, props) => {
  ...
  const getDataAsCsv = React134.useCallback((options = {}) => {
  ...
  const exportDataAsCsv = React134.useCallback((options) => {
  ...
  const addExportMenuButtons = React134.useCallback((initialValue, options) => {
    var _a;
...
var useGridPaginationModel = (apiRef, props) => {
  ...
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const previousFilterModel = React135.useRef(gridFilterModelSelector(apiRef));
  ...
  const setPage = React135.useCallback((page) => {
  ...
  const setPageSize = React135.useCallback((pageSize) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const setPaginationModel = React135.useCallback((paginationModel) => {
    const currentModel = gridPaginationModelSelector(apiRef);
  ...
  const handleUpdateAutoPageSize = React135.useCallback(() => {
  ...
  const handleRowCountChange = React135.useCallback((newRowCount) => {
    if (newRowCount == null) {
      return;
    }
    const paginationModel = gridPaginationModelSelector(apiRef);
  ...
  const navigateToStart = React135.useCallback(() => {
    const paginationModel = gridPaginationModelSelector(apiRef);
    if (paginationModel.page !== 0) {
  ...
  const handleFilterModelChange = React135.useCallback((filterModel) => {
  ...
  const isFirstRender = React135.useRef(true);
  React135.useEffect(() => {
    if (isFirstRender.current) {
      isFirstRender.current = false;
      return;
  ...
  React135.useEffect(handleUpdateAutoPageSize, [handleUpdateAutoPageSize]);
};
...
var useGridPrintExport = (apiRef, props) => {
  ...
  const doc = React136.useRef(null);
  const previousGridState = React136.useRef(null);
  const previousColumnVisibility = React136.useRef({});
  const previousRows = React136.useRef([]);
  const previousVirtualizationState = React136.useRef(null);
  React136.useEffect(() => {
    doc.current = ownerDocument(apiRef.current.rootElementRef.current);
  }, [apiRef, hasRootReference]);
  const updateGridColumnsForPrint = React136.useCallback((fields, allColumns, includeCheckboxes) => new Promise((resolve) => {
  ...
  const updateGridRowsForPrint = React136.useCallback((getRowsToExport) => {
  ...
  const handlePrintWindowLoad = React136.useCallback((printWindow, options) => {
    var _a, _b, _c;
...
`;
  ...
  const handlePrintWindowAfterPrint = React136.useCallback((printWindow) => {
    var _a, _b;
  ...
  const exportDataAsPrint = React136.useCallback(async (options) => {
  ...
  const addExportMenuButtons = React136.useCallback((initialValue, options) => {
    var _a;
...
var useGridFilter = (apiRef, props) => {
  ...
  const updateFilteredRows = React137.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const addColumnMenuItem = React137.useCallback((columnMenuItems, colDef) => {
    if (colDef == null || colDef.filterable === false || props.disableColumnFilter) {
      return columnMenuItems;
    }
    return [...columnMenuItems, "columnMenuFilterItem"];
  }, [props.disableColumnFilter]);
  const applyFilters = React137.useCallback(() => {
    updateFilteredRows();
    apiRef.current.forceUpdate();
  }, [apiRef, updateFilteredRows]);
  const upsertFilterItem = React137.useCallback((item) => {
  ...
  const upsertFilterItems = React137.useCallback((items) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const deleteFilterItem = React137.useCallback((itemToDelete) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const showFilterPanel = React137.useCallback((targetColumnField, panelId, labelId) => {
  ...
  const hideFilterPanel = React137.useCallback(() => {
    logger.debug("Hiding filter panel");
    apiRef.current.hidePreferences();
  }, [apiRef, logger]);
  const setFilterLogicOperator = React137.useCallback((logicOperator) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setQuickFilterValues = React137.useCallback((values) => {
    const filterModel = gridFilterModelSelector(apiRef);
  ...
  const setFilterModel = React137.useCallback((model, reason) => {
  ...
  const getFilterState = React137.useCallback((inputFilterModel) => {
  ...
  const flatFilteringMethod = React137.useCallback((params) => {
    var _a2;
  ...
  const handleColumnsChange = React137.useCallback(() => {
  ...
  const handleStrategyProcessorChange = React137.useCallback((methodName) => {
    if (methodName === "filtering") {
      apiRef.current.unstable_applyFilters();
    }
  }, [apiRef]);
  const updateVisibleRowsLookupState = React137.useCallback(() => {
    apiRef.current.setState((state) => {
      return _extends({}, state, {
...
var useGridFocus = (apiRef, props) => {
  ...
  const lastClickedCell = React138.useRef(null);
  const hasRootReference = apiRef.current.rootElementRef.current !== null;
  const publishCellFocusOut = React138.useCallback((cell, event) => {
    if (cell) {
  ...
  const setCellFocus = React138.useCallback((id, field) => {
    const focusedCell = gridFocusCellSelector(apiRef);
  ...
  const setColumnHeaderFocus = React138.useCallback((field, event = {}) => {
  ...
  const setColumnHeaderFilterFocus = React138.useCallback((field, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    publishCellFocusOut(cell, event);
    apiRef.current.setState((state) => {
  ...
  const setColumnGroupHeaderFocus = React138.useCallback((field, depth, event = {}) => {
    const cell = gridFocusCellSelector(apiRef);
    if (cell) {
      apiRef.current.publishEvent("cellFocusOut", apiRef.current.getCellParams(cell.id, cell.field), event);
    }
  ...
  const getColumnGroupHeaderFocus = React138.useCallback(() => gridFocusColumnGroupHeaderSelector(apiRef), [apiRef]);
  const moveFocusToRelativeCell = React138.useCallback((id, field, direction) => {
  ...
  const handleCellDoubleClick = React138.useCallback(({
    id,
    field
  }) => {
    apiRef.current.setCellFocus(id, field);
  }, [apiRef]);
  const handleCellKeyDown = React138.useCallback((params, event) => {
    if (event.key === "Enter" || event.key === "Tab" || event.key === "Shift" || isNavigationKey(event.key)) {
      return;
    }
    apiRef.current.setCellFocus(params.id, params.field);
  }, [apiRef]);
  const handleColumnHeaderFocus = React138.useCallback(({
    field
  }, event) => {
  ...
  const handleColumnGroupHeaderFocus = React138.useCallback(({
    fields,
    depth
  }, event) => {
    if (event.target !== event.currentTarget) {
  ...
  const handleBlur = React138.useCallback((_, event) => {
    var _a, _b;
  ...
  const handleCellMouseDown = React138.useCallback((params) => {
    lastClickedCell.current = params;
  }, []);
  const handleDocumentClick = React138.useCallback((event) => {
  ...
  const handleCellModeChange = React138.useCallback((params) => {
  ...
  const handleRowSet = React138.useCallback(() => {
    const cell = gridFocusCellSelector(apiRef);
...
var useGridKeyboardNavigation = (apiRef, props) => {
  ...
  const getCurrentPageRows = React139.useCallback(() => {
    return gridVisibleRowsWithPinnedRowsSelector(apiRef);
  }, [apiRef]);
  const headerFilteringEnabled = props.signature !== "DataGrid" && props.headerFilters;
  const goToCell = React139.useCallback((colIndex, rowId, closestColumnToUse = "left", rowSpanScanDirection = "up") => {
  ...
  const goToHeader = React139.useCallback((colIndex, event) => {
  ...
  const goToHeaderFilter = React139.useCallback((colIndex, event) => {
  ...
  const goToGroupHeader = React139.useCallback((colIndex, depth, event) => {
    logger.debug(`Navigating to header col ${colIndex}`);
    apiRef.current.scrollToIndexes({
      colIndex
    });
  ...
  const getRowIdFromIndex = React139.useCallback((rowIndex) => {
    var _a;
    return (_a = getCurrentPageRows()[rowIndex]) == null ? void 0 : _a.id;
  }, [getCurrentPageRows]);
  const handleColumnHeaderKeyDown = React139.useCallback((params, event) => {
  ...
  const handleHeaderFilterKeyDown = React139.useCallback((params, event) => {
  ...
  const handleColumnGroupHeaderKeyDown = React139.useCallback((params, event) => {
    const focusedColumnGroup = gridFocusColumnGroupHeaderSelector(apiRef);
  ...
  const handleCellKeyDown = React139.useCallback((params, event) => {
    if (isEventTargetInPortal(event)) {
      return;
    }
  ...
  const checkIfCanStartEditing = React139.useCallback((initialValue, {
    event
  }) => {
    if (event.key === " ") {
      return false;
...
var useGridRowCount = (apiRef, props) => {
  ...
  const setRowCount = React140.useCallback((newRowCount) => {
  ...
  useGridRegisterPipeProcessor(apiRef, "exportState", stateExportPreProcessing);
  useGridRegisterPipeProcessor(apiRef, "restoreState", stateRestorePreProcessing);
  const handlePaginationModelChange = React140.useCallback((model) => {
...
var useGridPaginationMeta = (apiRef, props) => {
  ...
  const setPaginationMeta = React141.useCallback((newPaginationMeta) => {
...
var useGridPreferencesPanel = (apiRef, props) => {
  ...
  const hidePreferences = React142.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const showPreferences = React142.useCallback((newValue, panelId, labelId) => {
...
var useGridCellEditing = (apiRef, props) => {
  const [cellModesModel, setCellModesModel] = React143.useState({});
  const cellModesModelRef = React143.useRef(cellModesModel);
  const prevCellModesModel = React143.useRef({});
  const {
    processRowUpdate,
  ...
  const throwIfNotEditable = React143.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React143.useCallback((id, field, mode) => {
    if (apiRef.current.getCellMode(id, field) !== mode) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const handleCellDoubleClick = React143.useCallback((params, event) => {
  ...
  const handleCellFocusOut = React143.useCallback((params, event) => {
  ...
  const handleCellEditStart = React143.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleCellEditStop = React143.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const getCellMode = React143.useCallback((id, field) => {
  ...
  const updateFieldInCellModesModel = React143.useCallback((id, field, newProps) => {
  ...
  const updateOrDeleteFieldState = React143.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
  ...
  const startCellEditMode = React143.useCallback((params) => {
    const {
      id,
      field
  ...
  const stopCellEditMode = React143.useCallback((params) => {
    const {
      id,
      field
  ...
  const setCellEditingEditCellValue = React143.useCallback(async (params) => {
    var _a, _b;
    const {
      id,
      field,
  ...
  const getRowWithUpdatedValuesFromCellEditing = React143.useCallback((id, field) => {
    const column = apiRef.current.getColumn(field);
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
...
var useGridRowEditing = (apiRef, props) => {
  const [rowModesModel, setRowModesModel] = React144.useState({});
  const rowModesModelRef = React144.useRef(rowModesModel);
  const prevRowModesModel = React144.useRef({});
  const prevRowValuesLookup = React144.useRef({});
  const focusTimeout = React144.useRef(void 0);
  const nextFocusedCell = React144.useRef(null);
  const {
    processRowUpdate,
    onProcessRowUpdateError,
  ...
  const throwIfNotEditable = React144.useCallback((id, field) => {
    const params = apiRef.current.getCellParams(id, field);
    if (!apiRef.current.isCellEditable(params)) {
      throw new Error(`MUI X: The cell with id=${id} and field=${field} is not editable.`);
    }
  }, [apiRef]);
  const throwIfNotInMode = React144.useCallback((id, mode) => {
    if (apiRef.current.getRowMode(id) !== mode) {
      throw new Error(`MUI X: The row with id=${id} is not in ${mode} mode.`);
    }
  }, [apiRef]);
  const hasFieldsWithErrors = React144.useCallback((rowId) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    return Object.values(editingState[rowId]).some((fieldProps) => fieldProps.error);
  }, [apiRef]);
  const handleCellDoubleClick = React144.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleCellFocusIn = React144.useCallback((params) => {
    nextFocusedCell.current = params;
  }, []);
  const handleCellFocusOut = React144.useCallback((params, event) => {
    if (!params.isEditable) {
      return;
    }
  ...
  const handleRowEditStart = React144.useCallback((params) => {
    const {
      id,
      field,
      reason
  ...
  const handleRowEditStop = React144.useCallback((params) => {
    const {
      id,
      reason,
      field
  ...
  const getRowMode = React144.useCallback((id) => {
  ...
  const updateRowInRowModesModel = React144.useCallback((id, newProps) => {
  ...
  const updateOrDeleteRowState = React144.useCallback((id, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
  ...
  const updateOrDeleteFieldState = React144.useCallback((id, field, newProps) => {
    apiRef.current.setState((state) => {
      const newEditingState = _extends({}, state.editRows);
      if (newProps !== null) {
        newEditingState[id] = _extends({}, newEditingState[id], {
  ...
  const startRowEditMode = React144.useCallback((params) => {
    const {
      id
  ...
  const stopRowEditMode = React144.useCallback((params) => {
    const {
      id
  ...
  const setRowEditingEditCellValue = React144.useCallback((params) => {
    const {
      id,
      field,
      value,
  ...
  const getRowWithUpdatedValuesFromRowEditing = React144.useCallback((id) => {
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
    const row = apiRef.current.getRow(id);
    if (!editingState[id]) {
      return apiRef.current.getRow(id);
...
var useGridEditing = (apiRef, props) => {
  ...
  const debounceMap = React145.useRef({});
  const {
    isCellEditable: isCellEditableProp
  } = props;
  const isCellEditable = React145.useCallback((params) => {
  ...
  const runPendingEditCellValueMutation = React145.useCallback((id, field) => {
    if (!debounceMap.current[id]) {
      return;
    }
    if (!field) {
  ...
  const setEditCellValue = React145.useCallback((params) => {
    const {
      id,
      field,
      debounceMs
  ...
  const getRowWithUpdatedValues = React145.useCallback((id, field) => {
    return props.editMode === GridEditModes.Cell ? apiRef.current.getRowWithUpdatedValuesFromCellEditing(id, field) : apiRef.current.getRowWithUpdatedValuesFromRowEditing(id);
  }, [apiRef, props.editMode]);
  const getEditCellMeta = React145.useCallback((id, field) => {
    var _a;
    const editingState = gridEditRowsStateSelector(apiRef.current.state);
...
var useGridRows = (apiRef, props) => {
  ...
  const lastUpdateMs = React146.useRef(Date.now());
  const lastRowCount = React146.useRef(props.rowCount);
  const timeout = useTimeout();
  const getRow = React146.useCallback((id) => {
  ...
  const getRowId = React146.useCallback((row) => gridRowIdSelector(apiRef.current.state, row), [apiRef]);
  const throttledRowsChange = React146.useCallback(({
    cache: cache2,
    throttle: throttle2
  }) => {
    const run = () => {
  ...
  const setRows = React146.useCallback((rows) => {
  ...
  const updateRows = React146.useCallback((updates) => {
  ...
  const updateServerRows = React146.useCallback((updates, groupKeys) => {
    const nonPinnedRowsUpdates = computeRowsUpdates(apiRef, updates, props.getRowId);
    const cache2 = updateCacheWithNewRows({
      updates: nonPinnedRowsUpdates,
      getRowId: props.getRowId,
  ...
  const setLoading = React146.useCallback((loading) => {
  ...
  const getRowModels = React146.useCallback(() => {
    const dataRows = gridDataRowIdsSelector(apiRef);
    const idRowsLookup = gridRowsLookupSelector(apiRef);
    return new Map(dataRows.map((id) => [id, idRowsLookup[id] ?? {}]));
  }, [apiRef]);
  const getRowsCount = React146.useCallback(() => gridRowCountSelector(apiRef), [apiRef]);
  const getAllRowIds = React146.useCallback(() => gridDataRowIdsSelector(apiRef), [apiRef]);
  const getRowIndexRelativeToVisibleRows = React146.useCallback((id) => {
    const row = apiRef.current.getRow(id);
    const {
      rowToIndexMap
  ...
  const setRowChildrenExpansion = React146.useCallback((id, isExpanded) => {
  ...
  const getRowNode = React146.useCallback((id) => gridRowTreeSelector(apiRef)[id] ?? null, [apiRef]);
  const getRowGroupChildren = React146.useCallback(({
  ...
  const setRowIndex = React146.useCallback((rowId, targetIndex) => {
  ...
  const replaceRows = React146.useCallback((firstRowToRender, newRows) => {
  ...
  const groupRows = React146.useCallback(() => {
  ...
  const handleStrategyActivityChange = React146.useCallback(() => {
  ...
  const applyHydrateRowsProcessor = React146.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const isFirstRender = React146.useRef(true);
  React146.useEffect(() => {
    var _a;
    if (isFirstRender.current) {
      isFirstRender.current = false;
...
function useGridParamsApi(apiRef, props) {
  var _a;
  const getColumnHeaderParams = React147.useCallback((field) => ({
    field,
    colDef: apiRef.current.getColumn(field)
  }), [apiRef]);
  const getRowParams = React147.useCallback((id) => {
    const row = apiRef.current.getRow(id);
    if (!row) {
  ...
  const getCellParamsForRow = React147.useCallback((id, field, row, {
    cellMode,
    colDef,
    hasFocus,
    rowNode,
  ...
  const getCellParams = React147.useCallback((id, field) => {
    var _a2;
    const row = apiRef.current.getRow(id);
    const rowNode = apiRef.current.getRowNode(id);
    if (!row || !rowNode) {
  ...
  const getCellValue2 = React147.useCallback((id, field) => {
    const colDef = apiRef.current.getColumn(field);
    const row = apiRef.current.getRow(id);
    if (!row) {
      throw new MissingRowIdError(`No row with id #${id} found`);
  ...
  const getRowValue = React147.useCallback((row, colDef) => {
  ...
  const getRowFormattedValue = React147.useCallback((row, colDef) => {
  ...
  const getColumnHeaderElement = React147.useCallback((field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridColumnHeaderElement(apiRef.current.rootElementRef.current, field);
  }, [apiRef]);
  const getRowElement = React147.useCallback((id) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
    return getGridRowElement(apiRef.current.rootElementRef.current, id);
  }, [apiRef]);
  const getCellElement = React147.useCallback((id, field) => {
    if (!apiRef.current.rootElementRef.current) {
      return null;
    }
...
var useGridRowSelection = (apiRef, props) => {
  ...
  const runIfRowSelectionIsEnabled = React148.useCallback((callback) => (...args) => {
  ...
  const propRowSelectionModel = React148.useMemo(() => {
    return getSelectionModelPropValue(props.rowSelectionModel, gridRowSelectionStateSelector(apiRef.current.state));
  }, [apiRef, props.rowSelectionModel]);
  const lastRowToggled = React148.useRef(null);
  apiRef.current.registerControlState({
  ...
  const expandMouseRowRangeSelection = React148.useCallback((id) => {
    let endId = id;
  ...
  const setRowSelectionModel = React148.useCallback((model) => {
  ...
  const isRowSelected = React148.useCallback((id) => gridRowSelectionStateSelector(apiRef.current.state).includes(id), [apiRef]);
  const isRowSelectable = React148.useCallback((id) => {
  ...
  const getSelectedRows = React148.useCallback(() => selectedGridRowsSelector(apiRef), [apiRef]);
  const selectRow = React148.useCallback((id, isSelected = true, resetSelection = false) => {
  ...
  const selectRows = React148.useCallback((ids, isSelected = true, resetSelection = false) => {
  ...
  const getPropagatedRowSelectionModel = React148.useCallback((inputSelectionModel) => {
    var _a2, _b2;
  ...
  const selectRowRange = React148.useCallback(({
    startId,
    endId
  ...
  const isFirstRender = React148.useRef(true);
  const removeOutdatedSelection = React148.useCallback((sortModelUpdated = false) => {
    var _a2;
    if (isFirstRender.current) {
      return;
    }
  ...
  const handleSingleRowSelection = React148.useCallback((id, event) => {
  ...
  const handleRowClick = React148.useCallback((params, event) => {
    var _a2;
  ...
  const preventSelectionOnShift = React148.useCallback((params, event) => {
    var _a2;
    if (canHaveMultipleSelection && event.shiftKey) {
      (_a2 = window.getSelection()) == null ? void 0 : _a2.removeAllRanges();
    }
  }, [canHaveMultipleSelection]);
  const handleRowSelectionCheckboxChange = React148.useCallback((params, event) => {
  ...
  const handleHeaderSelectionCheckboxChange = React148.useCallback((params) => {
...
var useGridRowSelectionPreProcessors = (apiRef, props) => {
  ...
  const updateSelectionColumn = React149.useCallback((columnsState) => {
...
var useGridSorting = (apiRef, props) => {
  ...
  const upsertSortModel = React150.useCallback((field, sortItem) => {
  ...
  const createSortItem = React150.useCallback((col, directionOverride) => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const addColumnMenuItem = React150.useCallback((columnMenuItems, colDef) => {
  ...
  const applySorting = React150.useCallback(() => {
    apiRef.current.setState((state) => {
  ...
  const setSortModel = React150.useCallback((model) => {
  ...
  const sortColumn = React150.useCallback((field, direction, allowMultipleSorting) => {
    const column = apiRef.current.getColumn(field);
  ...
  const getSortModel = React150.useCallback(() => gridSortModelSelector(apiRef), [apiRef]);
  const getSortedRows = React150.useCallback(() => {
    const sortedRows = gridSortedRowEntriesSelector(apiRef);
    return sortedRows.map((row) => row.model);
  }, [apiRef]);
  const getSortedRowIds = React150.useCallback(() => gridSortedRowIdsSelector(apiRef), [apiRef]);
  const getRowIdFromRowIndex = React150.useCallback((index) => apiRef.current.getSortedRowIds()[index], [apiRef]);
  const sortApi = {
    getSortModel,
    getSortedRows,
    getSortedRowIds,
  ...
  const flatSortingMethod = React150.useCallback((params) => {
    const rowTree = gridRowTreeSelector(apiRef);
  ...
  const handleColumnHeaderClick = React150.useCallback(({
    field,
    colDef
  }, event) => {
  ...
  const handleColumnHeaderKeyDown = React150.useCallback(({
    field,
    colDef
  }, event) => {
    if (!colDef.sortable || props.disableColumnSorting) {
  ...
  const handleColumnsChange = React150.useCallback(() => {
    const sortModel = gridSortModelSelector(apiRef);
  ...
  const handleStrategyProcessorChange = React150.useCallback((methodName) => {
...
var useGridScroll = (apiRef, props) => {
  ...
  const scrollToIndexes = React151.useCallback((params) => {
    var _a;
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const scroll = React151.useCallback((params) => {
  ...
  const getScrollPosition = React151.useCallback(() => {
...
function useGridDimensions(apiRef, props) {
  ...
  const errorShown = React152.useRef(false);
  const rootDimensionsRef = React152.useRef(EMPTY_SIZE);
  const pinnedColumns = useGridSelector(apiRef, gridVisiblePinnedColumnDefinitionsSelector);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  const columnsTotalWidth = useGridSelector(apiRef, columnsTotalWidthSelector);
  const isFirstSizing = React152.useRef(true);
  const {
    rowHeight,
    headerHeight,
    groupHeaderHeight,
  ...
  const previousSize = React152.useRef(void 0);
  const getRootDimensions = React152.useCallback(() => gridDimensionsSelector(apiRef.current.state), [apiRef]);
  const setDimensions = React152.useCallback((dimensions) => {
    apiRef.current.setState((state) => _extends({}, state, {
      dimensions
    }));
    if (apiRef.current.rootElementRef.current) {
  ...
  const resize = React152.useCallback(() => {
  ...
  const getViewportPageSize = React152.useCallback(() => {
    const dimensions = gridDimensionsSelector(apiRef.current.state);
  ...
  const updateDimensions = React152.useCallback(() => {
    var _a, _b;
  ...
  const debouncedUpdateDimensions = React152.useMemo(() => props.resizeThrottleMs > 0 ? throttle(() => {
    updateDimensionCallback();
    apiRef.current.publishEvent("debouncedResize", rootDimensionsRef.current);
  }, props.resizeThrottleMs) : void 0, [apiRef, props.resizeThrottleMs, updateDimensionCallback]);
  React152.useEffect(() => debouncedUpdateDimensions == null ? void 0 : debouncedUpdateDimensions.clear, [debouncedUpdateDimensions]);
  const apiPublic = {
    resize,
    getRootDimensions
  };
  ...
  const handleRootMount = React152.useCallback((root) => {
    setCSSVariables(root, gridDimensionsSelector(apiRef.current.state));
  }, [apiRef]);
  const handleResize = React152.useCallback((size) => {
...
var useGridRowsMeta = (apiRef, props) => {
  ...
  const lastMeasuredRowIndex = React153.useRef(-1);
  const hasRowWithAutoHeight = React153.useRef(false);
  const isHeightMetaValid = React153.useRef(false);
  const densityFactor = useGridSelector(apiRef, gridDensityFactorSelector);
  ...
  const processHeightEntry = React153.useCallback((row) => {
  ...
  const hydrateRowsMeta = React153.useCallback(() => {
...
var useGridStatePersistence = (apiRef) => {
  const exportState = React154.useCallback((params = {}) => {
    const stateToExport = apiRef.current.unstable_applyPipeProcessors("exportState", {}, params);
    return stateToExport;
  }, [apiRef]);
  const restoreState = React154.useCallback((stateToRestore) => {
...
var useGridColumnSpanning = (apiRef) => {
  ...
  const calculateColSpan = React155.useCallback(({
    rowId,
    minFirstColumn,
    maxLastColumn,
    columns
...
var useGridColumnGrouping = (apiRef, props) => {
  const getColumnGroupPath = React156.useCallback((field) => {
    const unwrappedGroupingModel = gridColumnGroupsUnwrappedModelSelector(apiRef);
    return unwrappedGroupingModel[field] ?? [];
  }, [apiRef]);
  const getAllGroupDetails = React156.useCallback(() => {
  ...
  const handleColumnIndexChange = React156.useCallback(() => {
    const unwrappedGroupingModel = unwrapGroupingColumnModel(props.columnGroupingModel ?? []);
    apiRef.current.setState((state) => {
      var _a;
  ...
  const updateColumnGroupingState = React156.useCallback((columnGroupingModel) => {
    var _a, _b;
...
function useColumnVirtualizationDisabled(apiRef) {
  const promise = React157.useRef(void 0);
...
var useGridColumnResize = (apiRef, props) => {
  ...
  const initialOffsetToSeparator = React157.useRef(null);
  const resizeDirection = React157.useRef(null);
  const stopResizeEventTimeout = useTimeout();
  const touchId = React157.useRef(void 0);
  ...
  const stopListening = React157.useCallback(() => {
    const doc = ownerDocument(apiRef.current.rootElementRef.current);
  ...
  const handleResizeStart = React157.useCallback(({
    field
  }) => {
    apiRef.current.setState((state) => _extends({}, state, {
  ...
  const handleResizeStop = React157.useCallback(() => {
    apiRef.current.setState((state) => _extends({}, state, {
      columnResize: _extends({}, state.columnResize, {
        resizingColumnField: ""
      })
  ...
  const isAutosizingRef = React157.useRef(false);
  const autosizeColumns = React157.useCallback(async (userOptions) => {
    var _a;
  ...
  React157.useEffect(() => stopListening, [stopListening]);
  useOnMount(() => {
...
var useGridRowSpanning = (apiRef, props) => {
  ...
  const updateRowSpanningState = React158.useCallback((renderContext, resetState = false) => {
    const {
      range: range2,
      rows: visibleRows
    } = getVisibleRows(apiRef, {
  ...
  const resetRowSpanningState = React158.useCallback(() => {
    const renderContext = gridRenderContextSelector(apiRef);
...
function useGridListView(apiRef, props) {
  ...
  const prevInnerWidth = React159.useRef(null);
...
function GridColumnGroupHeader(props) {
  ...
  const style = React160.useMemo(() => attachPinnedStyle(_extends({}, props.style), isRtl, pinnedPosition, pinnedOffset), [pinnedPosition, pinnedOffset, props.style, isRtl]);
...
var useDataGridProps = (inProps) => {
  ...
  const localeText = React167.useMemo(() => _extends({}, GRID_DEFAULT_LOCALE_TEXT, themedProps.localeText), [themedProps.localeText]);
  const slots = React167.useMemo(() => computeSlots({
    defaultSlots,
    slots: themedProps.slots
  }), [themedProps.slots]);
  const injectDefaultProps = React167.useMemo(() => {
    return Object.keys(DATA_GRID_PROPS_DEFAULT_VALUES).reduce((acc, key) => {
      acc[key] = themedProps[key] ?? DATA_GRID_PROPS_DEFAULT_VALUES[key];
      return acc;
    }, {});
  }, [themedProps]);
  return React167.useMemo(() => _extends({}, themedProps, injectDefaultProps, {
    localeText,
    slots
...
var DataGrid2 = React168.memo(DataGridRaw);
DataGridRaw.propTypes = {
  ...
  autosizeOptions: import_prop_types64.default.shape({
    ...
    disableColumnVirtualization: import_prop_types64.default.bool,
   ...
   */
  columnGroupHeaderHeight: import_prop_types64.default.number,
   ...
   * @param {MuiEvent<React.MouseEvent>} event The event object.
   */
  onColumnHeaderContextMenu: import_prop_types64.default.func,
  /**
   ...
   * @default false
   */
  resetPageOnSortFilter: import_prop_types64.default.bool,
  /**
   ...
   * @default false
   */
  unstable_rowSpanning: import_prop_types64.default.bool,
  /**
   ...
   * @default false
   */
  virtualizeColumnsWithAutoRowHeight: import_prop_types64.default.bool
};
export {
