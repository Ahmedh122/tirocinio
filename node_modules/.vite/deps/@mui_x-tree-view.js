...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/composeClasses/composeClasses.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/ClassNameGenerator/ClassNameGenerator.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/generateUtilityClass/generateUtilityClass.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/generateUtilityClasses/generateUtilityClasses.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/isHostComponent/isHostComponent.js
function isHostComponent(element) {
  return typeof element === "string";
}
var isHostComponent_default = isHostComponent;

// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/appendOwnerState/appendOwnerState.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/omitEventHandlers/omitEventHandlers.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/mergeSlotProps/mergeSlotProps.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/resolveComponentProps/resolveComponentProps.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/useSlotProps/useSlotProps.js
...
var useTreeViewModels = (plugins, props) => {
  const modelsRef = React2.useRef({});
  const [modelsState, setModelsState] = React2.useState(() => {
    const initialState = {};
...
var useTreeViewInstanceEvents = () => {
  const [eventManager] = React3.useState(() => new EventManager());
  const publishEvent = React3.useCallback((...args) => {
  ...
  const subscribeEvent = React3.useCallback((event, handler) => {
...
var TreeViewContext = React6.createContext(null);
if (true) {
...
var useTreeViewContext = () => {
  const context = React8.useContext(TreeViewContext);
  if (context == null) {
...
var TreeViewItemDepthContext = React9.createContext(() => -1);
if (true) {
...
var useTreeViewItems = ({
  ...
  const getItemMeta = React10.useCallback((itemId) => state.items.itemMetaMap[itemId], [state.items.itemMetaMap]);
  const getItem = React10.useCallback((itemId) => state.items.itemMap[itemId], [state.items.itemMap]);
  const getItemTree = React10.useCallback(() => {
  ...
  const isItemDisabled = React10.useCallback((itemId) => {
    if (itemId == null) {
      return false;
    }
  ...
  const getItemIndex = React10.useCallback((itemId) => {
  ...
  const getItemOrderedChildrenIds = React10.useCallback((itemId) => state.items.itemOrderedChildrenIds[itemId ?? TREE_VIEW_ROOT_PARENT_ID] ?? [], [state.items.itemOrderedChildrenIds]);
  ...
  const areItemUpdatesPreventedRef = React10.useRef(false);
  const preventItemUpdates = React10.useCallback(() => {
    areItemUpdatesPreventedRef.current = true;
  }, []);
  const areItemUpdatesPrevented = React10.useCallback(() => areItemUpdatesPreventedRef.current, []);
  React10.useEffect(() => {
...
var useTreeViewExpansion = ({
  ...
  const expandedItemsMap = React13.useMemo(() => {
  ...
  const isItemExpanded = React13.useCallback((itemId) => expandedItemsMap.has(itemId), [expandedItemsMap]);
  const isItemExpandable3 = React13.useCallback((itemId) => {
    var _a;
  ...
  const expansionTrigger = React13.useMemo(() => {
...
var useTreeViewSelection = ({
  ...
  const lastSelectedItem = React14.useRef(null);
  const lastSelectedRange = React14.useRef({});
  const selectedItemsMap = React14.useMemo(() => {
    const temp = /* @__PURE__ */ new Map();
...
function createUseInstanceEventHandler(registryContainer2) {
  ...
  return function useInstanceEventHandler2(instance, eventName, handler) {
    ...
    const [objectRetainedByReact] = React15.useState(new ObjectToBeRetainedByReact());
    const subscription = React15.useRef(null);
    const handlerRef = React15.useRef(void 0);
    handlerRef.current = handler;
    const cleanupTokenRef = React15.useRef(null);
...
var useTreeViewFocus = ({
  ...
  const isTreeViewFocused = React16.useCallback(() => !!rootRef.current && rootRef.current.contains(getActiveElement(ownerDocument(rootRef.current))), [rootRef]);
  const isItemFocused = React16.useCallback((itemId) => state.focusedItemId === itemId && isTreeViewFocused(), [state.focusedItemId, isTreeViewFocused]);
...
var useTreeViewLabelItemPlugin = ({
  ...
  const [labelInputValue, setLabelInputValue] = React17.useState(label);
...
var useTreeViewLabel = ({
  ...
  const editedItemRef = React18.useRef(state.editedItemId);
...
var useTreeViewKeyboardNavigation = ({
  ...
  const isRtl = useRtl();
  const firstCharMap = React19.useRef({});
...
var TreeViewChildrenItemContext = React20.createContext(null);
if (true) {
...
function TreeViewChildrenItemProvider(props) {
  ...
  const childrenIdAttrToIdRef = React20.useRef(/* @__PURE__ */ new Map());
  React20.useEffect(() => {
    if (!rootRef.current) {
      return;
    }
...
var useTreeViewJSXItemsItemPlugin = ({
  ...
  const parentContext = React21.useContext(TreeViewChildrenItemContext);
  ...
  const pluginContentRef = React21.useRef(null);
...
useTreeViewJSXItems.wrapItem = ({
  ...
  const depthContext = React21.useContext(TreeViewItemDepthContext);
...
var EMPTY_ITEMS = [];
var SimpleTreeView = React22.forwardRef(function SimpleTreeView2(inProps, ref) {
...
var TreeView = React23.forwardRef(function TreeView2(inProps, ref) {
  if (true) {
    warn();
  }
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/unsupportedProp/unsupportedProp.js
...
// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/elementTypeAcceptingRef/elementTypeAcceptingRef.js
var import_prop_types4 = __toESM(require_prop_types(), 1);

// node_modules/@mui/x-tree-view/node_modules/@mui/utils/esm/chainPropTypes/chainPropTypes.js
...
var TreeItemContent = React25.forwardRef(function TreeItemContent2(props, ref) {
  const {
    classes,
    className,
    displayIcon,
...
true ? TreeItemContent.propTypes = {
  ...
  dragAndDropOverlayProps: import_prop_types6.default.shape({
    action: import_prop_types6.default.oneOf(["make-child", "move-to-parent", "reorder-above", "reorder-below"]),
  ...
  labelInputProps: import_prop_types6.default.shape({
    autoFocus: import_prop_types6.default.oneOf([true]),
    "data-element": import_prop_types6.default.oneOf(["labelInput"]),
    onBlur: import_prop_types6.default.func,
    onChange: import_prop_types6.default.func,
    onKeyDown: import_prop_types6.default.func,
    type: import_prop_types6.default.oneOf(["text"]),
...
var TreeItem = React27.forwardRef(function TreeItem2(inProps, inRef) {
  var _a, _b, _c, _d;
  const {
    icons: contextIcons,
    runItemPlugins,
...
true ? TreeItem.propTypes = {
   ...
   * @deprecated Consider using the `<TreeItem2 />` component or the `useTreeItem2` hook instead. For more details, see https://mui.com/x/react-tree-view/tree-item-customization/.
   */
  ContentProps: import_prop_types8.default.object,
  /**
   ...
   * The id of the item.
   */
  itemId: import_prop_types8.default.string.isRequired,
  /**
   * The Tree Item label.
   */
...
function WrappedTreeItem({
  ...
  const children = React28.useMemo(() => itemsToRender ? (0, import_jsx_runtime11.jsx)(RichTreeViewItems, {
    itemsToRender,
    slots,
    slotProps
...
var RichTreeView = React29.forwardRef(function RichTreeView2(inProps, ref) {
...
true ? RichTreeView.propTypes = {
  ...
  apiRef: import_prop_types9.default.shape({
    current: import_prop_types9.default.shape({
      focusItem: import_prop_types9.default.func.isRequired,
      getItem: import_prop_types9.default.func.isRequired,
      getItemDOMElement: import_prop_types9.default.func.isRequired,
      getItemOrderedChildrenIds: import_prop_types9.default.func.isRequired,
      getItemTree: import_prop_types9.default.func.isRequired,
      selectItem: import_prop_types9.default.func.isRequired,
      setItemExpansion: import_prop_types9.default.func.isRequired,
      updateItemLabel: import_prop_types9.default.func.isRequired
    })
  }),
  /**
   * If `true`, the Tree View renders a checkbox at the left of its label that allows selecting it.
   ...
   * @default []
   */
  defaultExpandedItems: import_prop_types9.default.arrayOf(import_prop_types9.default.string),
  /**
   * Selected item ids. (Uncontrolled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   * @default []
   */
  defaultSelectedItems: import_prop_types9.default.any,
  /**
   * If `true`, will allow focus on disabled items.
   * @default false
   */
   ...
   * @default false
   */
  disableSelection: import_prop_types9.default.bool,
  /**
   * Expanded item ids.
   * Used when the item's expansion is controlled.
   */
  expandedItems: import_prop_types9.default.arrayOf(import_prop_types9.default.string),
  /**
   * The slot that triggers the item's expansion when clicked.
   * @default 'content'
   */
  expansionTrigger: import_prop_types9.default.oneOf(["content", "iconContainer"]),
  /**
   * Unstable features, breaking changes might be introduced.
   * For each feature, if the flag is not explicitly set to `true`,
   * the feature will be fully disabled and any property / method call will not have any effect.
  ...
  experimentalFeatures: import_prop_types9.default.shape({
    indentationAtItemLevel: import_prop_types9.default.bool,
    labelEditing: import_prop_types9.default.bool
  }),
  /**
   ...
   */
  getItemId: import_prop_types9.default.func,
  /**
   ...
   */
  getItemLabel: import_prop_types9.default.func,
  /**
   * This prop is used to help implement the accessibility logic.
   * If you don't provide this prop. It falls back to a randomly generated id.
   */
   ...
   */
  isItemDisabled: import_prop_types9.default.func,
  /**
   ...
   */
  isItemEditable: import_prop_types9.default.oneOfType([import_prop_types9.default.func, import_prop_types9.default.bool]),
  /**
   * Horizontal indentation between an item and its children.
   * Examples: 24, "24px", "2rem", "2em".
   * @default 12px
   */
  itemChildrenIndentation: import_prop_types9.default.oneOfType([import_prop_types9.default.number, import_prop_types9.default.string]),
  items: import_prop_types9.default.array.isRequired,
  /**
   * If `true`, `ctrl` and `shift` will trigger multiselect.
   * @default false
   */
  multiSelect: import_prop_types9.default.bool,
  /**
   * Callback fired when Tree Items are expanded/collapsed.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {array} itemIds The ids of the expanded items.
   */
  onExpandedItemsChange: import_prop_types9.default.func,
  /**
   * Callback fired when the `content` slot of a given Tree Item is clicked.
   * @param {React.MouseEvent} event The DOM event that triggered the change.
   * @param {string} itemId The id of the focused item.
   ...
   * @param {array} isExpanded `true` if the item has just been expanded, `false` if it has just been collapsed.
   */
  onItemExpansionToggle: import_prop_types9.default.func,
  /**
   * Callback fired when a given Tree Item is focused.
   * @param {React.SyntheticEvent | null} event The DOM event that triggered the change. **Warning**: This is a generic event not a focus event.
   * @param {string} itemId The id of the focused item.
   */
  onItemFocus: import_prop_types9.default.func,
  /**
   * Callback fired when the label of an item changes.
   * @param {TreeViewItemId} itemId The id of the item that was edited.
   * @param {string} newLabel The new label of the items.
   */
  onItemLabelChange: import_prop_types9.default.func,
  /**
   * Callback fired when a Tree Item is selected or deselected.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {array} itemId The itemId of the modified item.
   * @param {array} isSelected `true` if the item has just been selected, `false` if it has just been deselected.
   */
  onItemSelectionToggle: import_prop_types9.default.func,
  /**
   * Callback fired when Tree Items are selected/deselected.
   * @param {React.SyntheticEvent} event The DOM event that triggered the change.
   * @param {string[] | string} itemIds The ids of the selected items.
   * When `multiSelect` is `true`, this is an array of strings; when false (default) a string.
   */
  onSelectedItemsChange: import_prop_types9.default.func,
  /**
   * Selected item ids. (Controlled)
   * When `multiSelect` is true this takes an array of strings; when false (default) a string.
   */
  selectedItems: import_prop_types9.default.any,
  /**
   * The props used for each component slot.
   * @default {}
   */
...
var useTreeItem2 = (parameters) => {
  ...
  const depthContext = React30.useContext(TreeViewItemDepthContext);
  const {
    id,
    itemId,
    label,
  ...
  const rootRefObject = React30.useRef(null);
  const contentRefObject = React30.useRef(null);
  const handleRootRef = useForkRef(rootRef, pluginRootRef, rootRefObject);
  const handleContentRef = useForkRef(contentRef, contentRefObject);
  const checkboxRef = React30.useRef(null);
  const idAttribute = generateTreeItemIdAttribute({
    itemId,
    treeId,
    id
...
true ? TreeItem2Icon.propTypes = {
  ...
  status: import_prop_types10.default.shape({
    disabled: import_prop_types10.default.bool.isRequired,
    editable: import_prop_types10.default.bool.isRequired,
    editing: import_prop_types10.default.bool.isRequired,
    expandable: import_prop_types10.default.bool.isRequired,
    expanded: import_prop_types10.default.bool.isRequired,
    focused: import_prop_types10.default.bool.isRequired,
    selected: import_prop_types10.default.bool.isRequired
  }).isRequired
} : void 0;
...
var TreeItem2Checkbox = styled_default(React32.forwardRef((props, ref) => {
  const {
    visible
...
var TreeItem22 = React32.forwardRef(function TreeItem23(inProps, forwardedRef) {
...
true ? TreeItem22.propTypes = {
   ...
   * Must be unique.
   */
  itemId: import_prop_types11.default.string.isRequired,
  /**
...
var useTreeViewApiRef = () => React33.useRef(void 0);
export {
